...
namespace CapSoft.API
{
    ...
    //Converted ASP.NET Identity Id column Changed string to Int
    ...
    public class ApplicationRoleManager : RoleManager<Role, int>
    {
        ...
        {
            var appRoleManager = new ApplicationRoleManager(new RoleStore<Role, int, UserRole>(context.Get<ApplicationDbContext>()));
